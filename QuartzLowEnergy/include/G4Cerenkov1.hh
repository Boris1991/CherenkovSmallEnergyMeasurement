...
#ifndef G4Cerenkov1_h
#define G4Cerenkov1_h 1
...
class G4Cerenkov1 : public G4VProcess
{
...
public:
  ...
  explicit G4Cerenkov1(const G4String& processName = "Cerenkov", 
             G4ProcessType type = fElectromagnetic);
  ~G4Cerenkov1();

  explicit G4Cerenkov1(const G4Cerenkov1 &right);
...
private:
  ...
  G4Cerenkov1& operator=(const G4Cerenkov1 &right) = delete;
...
inline
G4bool G4Cerenkov1::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline
G4double G4Cerenkov1::GetMaxBetaChangePerStep() const
{
  return fMaxBetaChange;
}

inline
G4int G4Cerenkov1::GetMaxNumPhotonsPerStep() const
{
  return fMaxPhotons;
}

inline
void G4Cerenkov1::SetStackPhotons(const G4bool stackingFlag)
{
        fStackingFlag = stackingFlag;
}

inline
G4bool G4Cerenkov1::GetStackPhotons() const
{
        return fStackingFlag;
}

inline
G4int G4Cerenkov1::GetNumPhotons() const
{
        return fNumPhotons;
}

inline
G4PhysicsTable* G4Cerenkov1::GetPhysicsTable() const
{
