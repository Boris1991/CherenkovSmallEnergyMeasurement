...
G4Cerenkov1::G4Cerenkov1(const G4String& processName, G4ProcessType type)
...
G4bool G4Cerenkov1::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  G4bool result = false;
...
void G4Cerenkov1::SetTrackSecondariesFirst(const G4bool state)
{
  fTrackSecondariesFirst = state;
}

void G4Cerenkov1::SetMaxBetaChangePerStep(const G4double value)
{
  fMaxBetaChange = value*CLHEP::perCent;
}

void G4Cerenkov1::SetMaxNumPhotonsPerStep(const G4int NumPhotons)
{
  fMaxPhotons = NumPhotons;
}

void G4Cerenkov1::BuildPhysicsTable(const G4ParticleDefinition&)
{
...
//
G4VParticleChange*
G4Cerenkov1::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
...
void G4Cerenkov1::BuildThePhysicsTable()
{
...
G4double G4Cerenkov1::GetMeanFreePath(const G4Track&,
                                           G4double,
                                           G4ForceCondition*)
{
  return 1.;
...
G4double G4Cerenkov1::PostStepGetPhysicalInteractionLength(
...
G4double
  G4Cerenkov1::GetAverageNumberOfPhotons(const G4double charge,
                                        const G4double beta, 
...
void G4Cerenkov1::DumpPhysicsTable() const
{
