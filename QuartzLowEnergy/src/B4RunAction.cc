...
{ 
  ...
  //analysisManager->SetNtupleManager(true);
...
analysisManager->CreateH1("electronSpectra","electron spectra", 50, 0*keV, 450*keV);
  ...
  //analysisManager->CreateH2("XY","Position distribution", 251, -100*mm, 100*mm, 251, -100*mm, 100*mm);//-100*mm, 100*mm);
  analysisManager->CreateH2("XY","", 101, -atan(100/10), atan(100/10), 101, -atan(100/10), atan(100/10));
  analysisManager->CreateH2("XY2","", 101, -40, 40, 101, -40, 40);
  //analysisManager->CreateH2("Lgap","trackL in gap", 5, 0., 0.00001*mm);
